...
import { Compass, Sparkles, Folder, Video, Image as ImageIcon, X, Tag, Eye, Lock, ArrowUpRight } from 'lucide-react';
...
export default function ExplorePage() {
  ...
  // Items inside active opened collection
  const collectionItems = activeCollection
    ? mediaList.filter((m) => m.collectionId === activeCollection.id || activeCollection.id === 'col-1')
    : [];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
      ...
      {/* Opened Collection View Modal — Shows Videos Separately and Photos Separately */}
      {activeCollection && (
